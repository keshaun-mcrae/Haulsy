...
export default function DriverHqScreen() {
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Driver HQ</Text>
        <View style={{ width: 36 }} />
      </View>
      ...
      <View style={styles.content}>
        <Card style={styles.card}>
          ...
          <Text style={styles.sub}>Go to Earn to see gigs and your weekly earnings.</Text>
          <View style={styles.btnRow}>
            <Pressable onPress={() => router.push("/(tabs)/earn")} style={({ pressed }) => [styles.primaryBtn, pressed && { opacity: 0.92 }]}>
              <Text style={styles.primaryText}>Open Earn</Text>
            </Pressable>
            <Pressable onPress={() => router.push("/(tabs)/profile/driver")} style={({ pressed }) => [styles.secondaryBtn, pressed && { opacity: 0.92 }]}>
              <Text style={styles.secondaryText}>Driver settings</Text>
            </Pressable>
          </View>
        </Card>
      </View>
